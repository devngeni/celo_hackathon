        ...
        <div className='container-B'>
            ...
            <div className='container-'>
                ...
                <div>
                    ...
                    <input type="text" placeholder='user name' className="register-username" onChange={(e) => setUsername(e.target.value.trim())} />
                </div>
                <div >
                    <input type="text" placeholder="Phone number" className='register-phnumber' onChange={(e) => setPhoneNumber(e.target.value.trim())} />
                </div>
                <div>
                    <input type="text" placeholder="E-mail" className="register-email" onChange={(e)=> setEmail(e.target.value.trim())} />
                </div>
                <div>
